...
@NamedQueries({
    @NamedQuery(name = "Examparameters.findAll", query = "SELECT e FROM Examparameters e")})
public class Examparameters implements Serializable {
    ...
    public Examparameters(Integer id, String examcode, String examname, String examdescription) {
    	this.id = id;
