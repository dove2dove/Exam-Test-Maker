...
public class Multiplechoiceanswers implements Serializable {
    ...
    public Multiplechoiceanswers(Integer id, String title, String answerchoice, String displayorder, boolean correctanswer, boolean candidateanswer) {
        this.id = id;
        this.username = "vdwoodie";
        this.title = title;
        this.answerchoice = answerchoice;
        this.displayorder = displayorder;
        this.correctanswer = correctanswer;
